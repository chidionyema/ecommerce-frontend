...
import { CheckCircle, Package, Truck, AlertCircle, ArrowRight } from 'lucide-react';
...
export default function CheckoutSuccessPage() {
  ...
  useEffect(() => {
    ...
    fetchOrderDetails();
  }, [token, sessionId, type, refreshSubscriptionStatus]);
  ...
  const getOrderIdDisplay = () => {
    if (orderDetails?.orderId) {
      ...
      return `TMP-${sessionId.substring(0, 8)}`;
    }
    return 'Pending';
  };
              ...
              <div className="p-6 sm:p-8">
                <div className="text-center">
                  ...
                  <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row justify-center gap-4">
                    <Link href="/store/cart" className="inline-flex items-center px-6 py-3 border border-gray-300 shadow-sm text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                      Return to Cart
                    </Link>
                    <Link href="/store/contact" className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                      Contact Support
                    </Link>
                  </div>
                </div>
      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mt-8">
            <Link href="/store/orders" className="inline-flex items-center justify-center px-6 py-3 border border-gray-300 shadow-sm text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              View Order History
            </Link>
            <Link href="/store/products" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              Continue Shopping
