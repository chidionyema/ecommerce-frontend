...
export default function SearchFilter({
  ...
  return (
    <Box className={className} style={style}>
      ...
      >
        ...
        <Box sx={{ 
          ...
          <PanelButtons 
            ...
            colors={colors}
            loading={loading}
            filterButtonRef={buttonRefs.filter}
            sortButtonRef={buttonRefs.sort}
            advancedButtonRef={buttonRefs.advanced}
          />
        </Box>
      ...
      {activePanel === 'filter' && (
        <FilterPanel 
          anchorEl={buttonRefs.filter.current}
      ...
      {activePanel === 'sort' && (
        <SortPanel 
          anchorEl={buttonRefs.sort.current}
          sortOptions={sortOptions}
          activeSort={activeSort}
          handleSortChange={handleSortChange}
          closePanel={closePanel}
      ...
      {activePanel === 'advanced' && (
        <AdvancedPanel 
          anchorEl={buttonRefs.advanced.current}
          pendingFilters={pendingFilters}
          handleFilterChange={handleFilterChangeWithLive}
          handleApplyFilters={handleApplyFilters}
          hasPendingChanges={hasPendingChanges}
