  ...
  testimonials: [
    {
      ...
      role: "CTO, TechCorp",
      content:
        "GLUStack's strategic approach transformed our entire development pipeline. Their enterprise expertise helped us resolve complex scaling issues that had plagued us for months.",
      avatar: "/avatar1.jpg",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "The precision and expertise they brought to our Azure migration delivered exceptional ROI. We've seen a 40% decrease in infrastructure costs and significantly improved reliability.",
      avatar: "/avatar2.jpg",
      rating: 5,
      projectType: "DevOps"
    },
    {
      ...
      content:
        "As a startup, we needed enterprise-level architecture but with a sustainable approach. GLUStack delivered exactly that, setting us up for sustainable growth without technical debt.",
      avatar: "/avatar3.jpg",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "Their team's ability to seamlessly integrate microservices into our legacy system exceeded our expectations. The migration was smooth and the performance gains were immediate.",
      avatar: "/avatar4.jpg",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "GLUStack's security implementation was remarkable. They identified vulnerabilities we weren't even aware of and implemented OAuth 2.0 with zero disruption to our customers.",
      avatar: "/avatar5.jpg",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "The knowledge transfer and documentation during our Kubernetes migration was exemplary. Our team is now fully self-sufficient thanks to their systematic approach to training.",
      avatar: "/avatar6.jpg",
      rating: 4,
...
// Define props for ElegantCheckmarkItem
...
const ElegantCheckmarkItem: React.FC<ElegantCheckmarkItemProps> = ({ text, icon: Icon }) => {
  ...
  return (
    <Box sx={{ display: "flex", alignItems: "center", gap: 1.2, mb: 1.5 }}>
      ...
      <Typography sx={{ fontSize: "0.9rem", letterSpacing: "0.015em" }} color="text.primary">
        {text}
      </Typography>
    </Box>
  );
