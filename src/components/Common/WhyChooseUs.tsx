...
import { Lightbulb, Rocket, ShieldCheck, TrendingUp, FileText, Video, Calendar, Download } from 'lucide-react';
...
const reasons = [
  { 
    ...
    icon: <Lightbulb strokeWidth={1.5} size={18} color="#FF9900" />, 
    color: '#FF9900'
  },
  { 
    id: 2, 
...
const WhyChooseUs = () => {
  ...
  // Refined elegant checkmark item
  const ElegantCheckmarkItem = ({ text, Icon }) => (
    ...
    >
      <Container maxWidth="lg" sx={styles.contentContainer}>
        ...
        >
          ...
          {/* Benefit cards using TechCard component with refined styling */}
          ...
          {/* Combined CTA section with refined styling */}
          <motion.div variants={ANIMATIONS.item}>
            <Paper elevation={2} sx={{ 
              ...
              >
                Explore our resources or schedule a consultation to discover how we can help your business
              </Typography>
